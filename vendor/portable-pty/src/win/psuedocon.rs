...
pub struct PsuedoCon {
    con: HPCON,
    // CreatePseudoConsole does not take Rust ownership of these pipe handles.
    // Keep them alive for the lifetime of the pseudoconsole; otherwise the
    // master reader observes EOF before the child can write its screen.
